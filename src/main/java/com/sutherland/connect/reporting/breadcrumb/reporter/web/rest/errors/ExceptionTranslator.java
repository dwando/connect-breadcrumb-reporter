package com.sutherland.connect.reporting.breadcrumb.reporter.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.sutherland.connect.reporting.breadcrumb.reporter.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.sutherland.connect.reporting.breadcrumb.reporter.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.sutherland.connect.reporting.breadcrumb.reporter.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.sutherland.connect.reporting.breadcrumb.reporter"
        );
    }
}
